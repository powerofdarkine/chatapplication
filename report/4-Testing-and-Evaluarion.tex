...
The system’s perceived responsiveness is primarily determined by the frontend’s polling intervals. 
...
Although not instantaneous, this performance is acceptable for the project’s scope and represents a reasonable trade-off for a short-polling implementation.
...
\begin{itemize}
    ...
    \item \textbf{Polling-Induced Latency:} Periodic polling at 2–3~second intervals introduces measurable delays, limiting responsiveness compared to real-time protocols.
\end{itemize}
